...
(function ($) {
    ...
    var L5Forum = {
         ...
         * `.timeago` class.
         */
        initTimeAgo: function initTimeAgo() {
            moment.locale('zh-cn');
        ...
        initEmoji: function initEmoji() {
            ...
            $('#reply_content').textcomplete([{ // emoji strategy
                match: /\B:([\-+\w]*)$/,
         ...
         * Autocomplete @user
         */
        initAutocompleteAtUser: function initAutocompleteAtUser() {
            var at_users = [],
                user,
                $users;
         ...
         */
        initTextareaAutoResize: function initTextareaAutoResize() {
            autosize($('textarea'));
        },
         ...
         * Code heightlight.
         */
        initHeightLight: function initHeightLight() {
            Prism.highlightAll();
        },
         ...
         * do content preview
         */
        runPreview: function runPreview() {
         ...
         */
        initEditorPreview: function initEditorPreview() {
            var self = this;
         ...
         * page for too long.
         */
        initNotificationsCount: function initNotificationsCount(argumen) {
            var self = this;
            if (Config.user_id > 0) {
                (function () {
                    var scheduleGetNotification = function scheduleGetNotification() {
         ...
         */
        initReplyOnPressKey: function initReplyOnPressKey() {
         ...
         */
        initDeleteForm: function initDeleteForm() {
         ...
         * Upload image
         */
        initInlineAttach: function initInlineAttach() {
            var self = this;
            $('#reply_content').inlineattachment({
                ...
                onUploadedFile: function onUploadedFile(response) {
         ...
         * problem.
         */
        forceImageDataType: function forceImageDataType() {
...
},{"autosize":2,"bootstrap-sass":3,"emojify.js":4,"inline-attachment/src/inline-attachment":5,"inline-attachment/src/jquery.inline-attachment":6,"jquery":9,"jquery-pjax/jquery.pjax":7,"jquery-textcomplete":8,"localforage":10,"marked":11,"moment":12,"nprogress":13,"prismjs":14,"scrollup/dist/jquery.scrollUp":16}],2:[function(require,module,exports){
/*!
	Autosize 3.0.14
	license: MIT
