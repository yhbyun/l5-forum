var $ = global.jQuery = require('jquery')
    ...
    , inlineAttachment = require('inline-attachment/src/inline-attachment')
...
require('scrollup/dist/jquery.scrollUp');
require('prismjs');
...
(function($){
    ...
    var L5Forum = {
            ...
            $('#reply_content').textcomplete([
                { // emoji strategy
                    ...
                    template: function (value) {
                        return '<img src="/build/images/emoji/' + value + '.png"></img>' + value;
                    },
        ...
        initInlineAttach: function() {
            var self = this;
            $('#reply_content').inlineattachment({
...
// reply a reply
global.replyOne = function(username) {
    var $replyContent = jQuery("#reply_content");
    var oldContent = $replyContent.val();
    var prefix = "@" + username + " ";
    var newContent = ''
