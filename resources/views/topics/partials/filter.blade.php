<ul class="pull-right list-inline remove-margin-bottom topic-filter">
    ...
    <li>
        <a {{ app('App\Topic')->present()->topicFilter('recent') }}>
    ...
    <li>
        <a {{ app('App\Topic')->present()->topicFilter('excellent') }}>
    ...
    <li>
        <a {{ app('App\Topic')->present()->topicFilter('vote') }}>
    ...
    <li>
        <a {{ app('App\Topic')->present()->topicFilter('noreply') }}>
